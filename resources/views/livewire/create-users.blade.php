...
<form wire:submit="save" class="max-w-sm mx-auto border-solid">
  ...
  <div class="flex items-center flex-col gap-2">
      <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cadastrar no sistema <span>🔥</span></button>
      <a href="{{route('index.livewire')}}" class="text-white bg-red-500 p-5 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring focus:ring-red-500">Voltar<span>🔥</span> </a>
  </div>
